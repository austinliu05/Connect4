...
connect4 = Blueprint('connect4', __name__)

app = Flask(__name__)
# Configure CORS
CORS(app, resources={r"/Connect4": {"origins": ["https://austinliu05.github.io", "http://localhost:3000"]}})

# Member API route
@connect4.route("/Connect4", methods = ["POST", "GET"])
def move():
    ...
    return jsonify("{'msg': 'POST method only pls'}"), 200
